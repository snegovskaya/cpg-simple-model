...
test_result = integrate.odeint(lambda *args: delegate_neuron(test_neuron, *args,), vars0, t) 
...
# test_result = integrate.odeint(lambda *args: delegate_muscle(test_muscle, *args,), vars0, t)
# print(test_result) 
# CN, FN = test_result.T 
